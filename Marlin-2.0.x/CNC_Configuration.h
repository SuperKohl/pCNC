...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB // Works for the MKS_GEN_L
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "PCB-CNC"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {403.07,403.07,403.07,403.07}  // default steps per unit for Ultimaker
...
#define DEFAULT_XYJERK                6.00    // (mm/sec) 
